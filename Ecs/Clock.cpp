...
void Clock::eraseClockComponent(size_t entity, ECS::ComponentType type, bool debug)
{
    ...
    if (debug == true) {
        std::cout << std::endl << "<<<<<<<<<<<< DEBUG : eraseClockComponent BEGIN <<<<<<<<<<<<" << std::endl;
        std::cout << "Entity ID from where the component will be removed : " << entity << std::endl << "Number of components before removal : " << _timersList[entity].size() << std::endl;
        std::cout << std::endl << "Removing component..." << std::endl << std::endl;
    }
    ...
    if (debug == true) {
        std::cout << "Entity ID from where the component is supposed to be removed : " << entity << std::endl << "Number of components after removal : " << _timersList[entity].size() << std::endl;
        std::cout << "<<<<<<<<<<<< DEBUG : eraseClockComponent END   <<<<<<<<<<<<" << std::endl << std::endl;
    }
}
